...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  try {
    ...
    // Set offering to approved (not live)
    ...
    console.error("Unpublish offering error:", error);
    const message = error instanceof Error ? error.message : "Failed to unpublish offering";
